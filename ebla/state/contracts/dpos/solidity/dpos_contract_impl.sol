// (c) 2022-2023, Ebla, Inc. All rights reserved.
...
contract DposDummyImpl {
    ...
    // New EBLA - Retun value for getUndelegationsV2 method
    ...
    // Undelegates <amount> of tokens from specified validator, returns unique undelegation_id
